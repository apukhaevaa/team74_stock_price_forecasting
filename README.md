...
1. **Разведочный анализ данных (EDA):** Для анализа активов и макроэкономических данных был выбран набор самых ликвидных активов, включая акции, сырьевые товары, индексы, облигации и валюты, торгуемые на американском рынке. Эти активы были загружены с помощью Yahoo Finance, и для каждого из них были собраны данные об их цене, объеме торгов и других показателях с 1990 года для анализа долгосрочных тенденций. Кроме того, через FRED API были собраны ключевые макроэкономические показатели для США, такие как ВВП, уровень безработицы, индекс потребительских цен (CPI), индекс промышленного производства (PMI), процентные ставки, торговый баланс, объемы экспорта и импорта. Эти данные объединены в единый набор для выявления взаимосвязей между ценовыми движениями активов и изменениями в экономике США.
