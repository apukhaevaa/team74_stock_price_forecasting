...
**С более подробной информацией о данных можно ознакомиться в файле dataset.md по ссылке https://github.com/apukhaevaa/team74_stock_price_forecasting/blob/main/dataset.md.**
...
![Описание изображения](./images/Unknown-18.png)
...
Устранение остаточной автокорреляции: Дифференцирование позволило устранить остаточную автокорреляцию, что делает временные ряды более пригодными для моделирования с использованием стационарных моделей, таких как ARIMA. 
